                ...
                container('awscli-image') {
                    script {
                        ...
                        sh """
                            ...
                            sha256sum control_output.json > control_output.json.sha256
                        """
                        ...
                        checksumLines.each { line ->
                            ...
                            } else if (line.startsWith("control_output.json:")) {
                        ...
                        def actualOutputHash = sh(script: "cat ${PWD}/control_output.json.sha256 | cut -d' ' -f1", returnStdout: true).trim()
